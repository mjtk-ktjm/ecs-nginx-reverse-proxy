# NGINX Reverse Proxy with Flask app

This implements the reverse proxy in one container pointing to a Flask app running with the builtin Flask webserver in a second container.

### Run Flask container Only
docker run -p 5000:5000 664ede069a2e
